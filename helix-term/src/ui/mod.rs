...
type FilePicker = Picker<PathBuf, PathBuf, helix_view::editor::FilePickerConfig>;
...
pub fn inject_files<CFG>(
    picker: &Picker<PathBuf, PathBuf, CFG>,
...
pub fn file_picker(root: PathBuf, config: &helix_view::editor::FilePickerConfig) -> FilePicker {
    ...
    let picker = Picker::new_with_config(
        *config,
        columns,
        0,
        [],
